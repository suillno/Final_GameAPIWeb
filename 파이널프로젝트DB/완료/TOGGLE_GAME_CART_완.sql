CREATE OR REPLACE NONEDITIONABLE PROCEDURE "SCOTT"."TOGGLE_GAME_CART" (
...
BEGIN
    ...
    IF v_count = 0 THEN
        ...
        p_result := 'SUCCESS: 장바구니 등록이 완료되었습니다.';
    ELSE
        DELETE FROM GAME_CART
        WHERE USER_NAME = p_user_name AND GAME_ID = p_game_id;
        p_result := 'SUCCESS: 장바구니 등록이 취소되었습니다.';
    END IF;
